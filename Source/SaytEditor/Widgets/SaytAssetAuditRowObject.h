...
#include "SaytAssetAuditRowObject.generated.h"
...
class SAYTEDITOR_API USaytAssetAuditRowObject : public UObject
{
	GENERATED_BODY()
	
public:
	UPROPERTY(BlueprintReadOnly, Category = "Sayt|AssetManager")
	FName AssetType;
