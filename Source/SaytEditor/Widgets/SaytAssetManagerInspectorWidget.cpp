...
#include "SaytAssetManagerInspectorWidget.h"

#include "SaytAssetAuditRowObject.h"
#include "Engine/AssetManager.h"

TArray<USaytAssetAuditRowObject*> USaytAssetManagerInspectorWidget::GetAssetAuditReport()
{
	TArray<USaytAssetAuditRowObject*> Result;
	...
	for (const FPrimaryAssetTypeInfo& TypeInfo : TypeInfos)
	{
		...
		{
			USaytAssetAuditRowObject* Row = NewObject<USaytAssetAuditRowObject>(this);
			Row->AssetId = AssetId;
