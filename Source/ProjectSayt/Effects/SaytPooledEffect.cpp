...
#include "Effects/SaytPooledEffect.h"
#include "NiagaraComponent.h"
#include "Components/AudioComponent.h"

// Sets default values
ASaytPooledEffect::ASaytPooledEffect()
{
...
void ASaytPooledEffect::PlayEffect(const FVector& Location, const FRotator& Rotation, float PitchMultiplier)
{
	...
	GetWorld()->GetTimerManager().SetTimer(
		FinishTimerHandle, this, &ASaytPooledEffect::OnFinishTimer,
		EffectDuration, false);
}

void ASaytPooledEffect::OnFinishTimer()
{
	SetActorHiddenInGame(true);
