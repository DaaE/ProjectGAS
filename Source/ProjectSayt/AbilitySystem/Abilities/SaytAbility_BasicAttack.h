...
#include "SaytGameplayAbility.h"
#include "AbilitySystem/Tasks/AbilityTask_WeaponTrace.h"
#include "SaytAbility_BasicAttack.generated.h"
 ...
 */
UCLASS()
class PROJECTSAYT_API USaytAbility_BasicAttack : public USaytGameplayAbility
{
	GENERATED_BODY()
	
public:
	USaytAbility_BasicAttack();
