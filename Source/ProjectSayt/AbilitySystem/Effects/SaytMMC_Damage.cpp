...
#include "SaytMMC_Damage.h"
#include "../Attributes/SaytAttributeSet_Combat.h"


USaytMMC_Damage::USaytMMC_Damage()
{
	// 가해자(Source)의 AttackPower를 캡처하겠다는 명세
	AttackPowerDef = FGameplayEffectAttributeCaptureDefinition(
		USaytAttributeSet_Combat::GetAttackPowerAttribute(),
...
float USaytMMC_Damage::CalculateBaseMagnitude_Implementation(const FGameplayEffectSpec& Spec) const
{
