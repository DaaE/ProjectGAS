...
#include "SaytInventoryItemWidget.generated.h"
 ...
 */
UCLASS()
class PROJECTSAYT_API USaytInventoryItemWidget : public UCommonUserWidget
{
	GENERATED_BODY()
	
public:
	void SetItemInstance(USaytItemInstance* Instance);
...
protected:
	...
	UPROPERTY()
	TObjectPtr<USaytItemInstance> CurrentInstance;
