...
void USaytInventoryItemWidget::SetItemInstance(USaytItemInstance* Instance)
{
	...
	const USaytItemDefinition* ItemDef = Instance->ItemDefinition;
	...
	IconStreamableHandle = Streamable.RequestAsyncLoad(
		ItemDef->Icon.ToSoftObjectPath(), FStreamableDelegate::CreateUObject(this, &USaytInventoryItemWidget::OnIconLoaded));
...
void USaytInventoryItemWidget::SetValidityTint(bool bValid) const
{
...
void USaytInventoryItemWidget::ResetTint() const
{
	IconImage->SetColorAndOpacity(FLinearColor::White);
}

FReply USaytInventoryItemWidget::NativeOnMouseButtonDown(const FGeometry& InGeometry, const FPointerEvent& InMouseEvent)
{
...
void USaytInventoryItemWidget::NativeOnDragDetected(const FGeometry& InGeometry, const FPointerEvent& InMouseEvent,
	UDragDropOperation*& OutOperation)
{
	...
	USaytItemDragDropOperation* DragOperation = NewObject<USaytItemDragDropOperation>();
	...
	USaytInventoryItemWidget* DragVisual = CreateWidget<USaytInventoryItemWidget>(GetOwningPlayer(), GetClass());
...
void USaytInventoryItemWidget::OnIconLoaded()
{
