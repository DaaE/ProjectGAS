...
#include "SaytItemDragDropOperation.generated.h"
 ...
 */
UCLASS()
class PROJECTSAYT_API USaytItemDragDropOperation : public UDragDropOperation
{
	GENERATED_BODY()
...
public:
	...
	TObjectPtr<USaytItemInstance> DraggedInstance;
