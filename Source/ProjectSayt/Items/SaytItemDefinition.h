...
#include "SaytItemDefinition.generated.h"

class USaytItemFragment;
class UTexture2D;
 ...
 */
UCLASS()
class PROJECTSAYT_API USaytItemDefinition : public UPrimaryDataAsset
{
	GENERATED_BODY()
...
public:	
	...
	TArray<TObjectPtr<USaytItemFragment>> Fragments;
	
	// 그리드에서 차지하는 칸 수. X = 가로, Y = 세로.
	UPROPERTY(EditDefaultsOnly, Category = "Sayt|Item")
	...
	UPROPERTY(EditDefaultsOnly, Category = "Sayt|Item", meta = (EditCondition = "bIsStackable"))
