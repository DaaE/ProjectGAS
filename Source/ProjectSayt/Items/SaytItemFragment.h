...
#include "SaytItemFragment.generated.h"

class ASaytCharacterBase;
...
class PROJECTSAYT_API USaytItemFragment : public UObject
{
	GENERATED_BODY()
...
public:
	...
	virtual void OnEquipped(ASaytCharacterBase* OwningCharacter) const {}
};
