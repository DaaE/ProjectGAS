...
#include "SaytItemInstance.generated.h"
 ...
 */
UCLASS()
class PROJECTSAYT_API USaytItemInstance : public UObject
{
	GENERATED_BODY()
...
public:
	...
	static USaytItemInstance* CreateInstance(UObject* Outer, USaytItemDefinition* Definition);
	
	// 이 인스턴스가 "어떤 종류"의 아이템인지 가리킴.
	UPROPERTY(BlueprintReadOnly)
	TObjectPtr<USaytItemDefinition> ItemDefinition;
