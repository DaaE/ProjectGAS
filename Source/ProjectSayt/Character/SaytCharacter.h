...
class PROJECTSAYT_API ASaytCharacter : public ASaytCharacterBase
...
protected:
	...
	UPROPERTY(EditDefaultsOnly, Category = "Debug")
	TObjectPtr<USaytItemDefinition> DebugTestItem;

	void DebugEquipTestItem();
	
	//Inventory
	UPROPERTY(VisibleAnywhere, Category = "Sayt|Inventory")
	...
	UPROPERTY(EditDefaultsOnly, Category = "Debug")
	TSubclassOf<USaytInventoryWidget> InventoryWidgetClass;

	UPROPERTY()
	TObjectPtr<USaytInventoryWidget> ActiveInventoryWidget;
